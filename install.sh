...
echo -e "  \033[32m✔ agi-auth CLI\033[0m         - Multi-account OAuth Manager & Launcher"
...
echo -e "  \033[36magi-auth login\033[0m          - Direct Google OAuth login, save & auto-launch agi"
